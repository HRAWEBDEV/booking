...
export default function MobileNav() {
 ...
 return (
  <nav className='grid fixed bg-background bottom-0 start-0 end-0 border-t border-input shadow-[0_-4px_8px] shadow-black/10 dark:shadow-white/10 z-(--website-mobile-nav-zindex) h-(--website-mobile-nav-height) lg:hidden grid-cols-3 text-neutral-600 dark:text-neutral-400'>
   <Button
    data-active='true'
    variant='ghost'
    size={'icon'}
