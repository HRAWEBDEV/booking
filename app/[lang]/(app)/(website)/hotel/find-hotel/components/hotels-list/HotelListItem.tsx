 ...
 return (
  ...
  >
   <CardHeader className='px-0! gap-0 relative shrink-0 group-data-[view="row"]:basis-64'>
    <div
     ref={sliderRef}
     className='keen-slider relative overflow-hidden rounded-xl group-data-[view="grid"]:rounded-b-none group-data-[view="row"]:rounded-l-none group-data-[view="row"]:rounded-tl-none group-data-[view="row"]:rounded-r-xl'
    >
