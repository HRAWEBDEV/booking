   ...
   {hotelImages && hotelImages.length ? (
    ...
    >
     ...
     {hotelImages.map((image, i) => (
      <div
       className='keen-slider__slide rounded-lg h-92 overflow-hidden cursor-pointer shrink-0'
       key={i}
   ...
   <div className='hidden md:block'>
    {hotelImages && hotelImages.length ? (
     <div ref={sliderRef} className='keen-slider relative'>
      {hotelImages.map((image, i) => (
       <button
        className='keen-slider__slide rounded-lg size-20 cursor-pointer shrink-0'
        key={i}
        onClick={() => {
